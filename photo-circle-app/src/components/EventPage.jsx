  ...
  return (
    <div className="container-fluid mt-4">
        <div className="d-flex justify-content-between align-items-center mb-3">
            ...
            <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#uploadPhotoModal">+ Add Photo</button>
        </div>
        ...
        <UploadPhotoModal eventId={eventId} onSuccess={async () => await refetch()} />
    </div>
  )
}
